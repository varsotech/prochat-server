...
func (x *RegisterRequest) Reset() {
	*x = RegisterRequest{}
	mi := &file_prochat_v1_auth_proto_msgTypes[0]
...
const file_prochat_v1_auth_proto_rawDesc = "" +
	...
	"\rLoginResponse\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\x12!\n" +
	"\faccess_token\x18\x02 \x01(\tR\vaccessTokenB\xaf\x01\n" +
	"\x0ecom.prochat.v1B\tAuthProtoP\x01ZIgithub.com/varso/protchat-server/internal/models/gen/prochat/v1;prochatv1\xa2\x02\x03PXX\xaa\x02\n" +
	"Prochat.V1\xca\x02\n" +
	"Prochat\\V1\xe2\x02\x16Prochat\\V1\\GPBMetadata\xea\x02\vProchat::V1b\x06proto3"

var (
	file_prochat_v1_auth_proto_rawDescOnce sync.Once
	file_prochat_v1_auth_proto_rawDescData []byte
)

func file_prochat_v1_auth_proto_rawDescGZIP() []byte {
	file_prochat_v1_auth_proto_rawDescOnce.Do(func() {
		file_prochat_v1_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_prochat_v1_auth_proto_rawDesc), len(file_prochat_v1_auth_proto_rawDesc)))
	})
...
func init() { file_prochat_v1_auth_proto_init() }
func file_prochat_v1_auth_proto_init() {
	if File_prochat_v1_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_prochat_v1_auth_proto_goTypes,
		DependencyIndexes: file_prochat_v1_auth_proto_depIdxs,
		MessageInfos:      file_prochat_v1_auth_proto_msgTypes,
	}.Build()
	File_prochat_v1_auth_proto = out.File
	file_prochat_v1_auth_proto_goTypes = nil
	file_prochat_v1_auth_proto_depIdxs = nil
}
