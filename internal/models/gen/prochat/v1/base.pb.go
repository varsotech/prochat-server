...
const file_prochat_v1_base_proto_rawDesc = "" +
	...
	"\x06Member\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04nameB\xaf\x01\n" +
	"\x0ecom.prochat.v1B\tBaseProtoP\x01ZIgithub.com/varso/protchat-server/internal/models/gen/prochat/v1;prochatv1\xa2\x02\x03PXX\xaa\x02\n" +
	"Prochat.V1\xca\x02\n" +
